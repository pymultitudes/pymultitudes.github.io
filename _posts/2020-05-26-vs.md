# How to use jupyter notebooks with vs code on macOS

I used a minimal install and did not install the [Conda](https://docs.conda.io/en/latest/) package. I tried Conda but it takes too much disk space for me. 

Instead I only installed python 3.8 from [python.org](https://www.python.org/downloads/) and pip from the command line. I created the environment and selected the interpreter in VSCode. This is necessary because macOS comes with a version of Python preinstalled so you do not want to mix the two! 
